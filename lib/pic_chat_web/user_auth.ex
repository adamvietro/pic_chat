defmodule PicChatWeb.UserAuth do
  use PicChatWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_pic_chat_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      PicChatWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule PicChatWeb.PageLive do
        use PicChatWeb, :live_view

        on_mount {PicChatWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{PicChatWeb.UserAuth, :ensure_authenticated}] do
